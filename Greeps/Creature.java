 ...
 * 
 * @author Michael Kolling, extended by Nicolas Ruh
 * @version 1.1
 */
public abstract class Creature extends Actor
{
    ...
    /**
     * Turn 'angle' degrees towards the right (clockwise). Also accepts negative values
     */
    ...
    /**
     * True if we are at a TomatoPile.
     */
    public final boolean atTomatoPile()
    {
    ...
    /**
     * Move forward roughly in the current direction. Sometimes we might get a 
     * little off course, because Greeps are not perfect at walking straight ahead.
     */
    public void move()
    {
     ...
     * Acceptable colors are: "red", "orange" and "purple". 
     */
     ...
     * that is, an integer between min (inclusive) and max (exclusive) 
     */
    ...
    /**
     * Spit a drop of paint onto the ground - provided the last spit was more than 10 acts ago.. 
     * We can spit in three colors: "red", "orange" and "purple". 
     */
